...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, help_text='Courses the student is enrolled in', related_name='enrolled_students', to='classes.course'),
        ),
        ...
        migrations.AddField(
            model_name='user',
            name='branch',
            field=models.ForeignKey(blank=True, help_text='Branch assignment for admin, teacher, and student', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='users', to='acounts.branch'),
        ),
    ]
