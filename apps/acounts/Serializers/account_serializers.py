...
class UserSerializer(DynamicFieldsModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'role', 'is_super', 'employee_id', 'student_id', 
        ...
        read_only_fields = [
            ...
            'is_deleted', 'deleted_at', 'employee_id', 'student_id'
        ]
        extra_kwargs = {
...
class UserProfileSerializer(DynamicFieldsModelSerializer):
    ...
    class Meta:
        model = UserProfile
        fields = [
            'id', 'user', 'user_id', 'bio', 'birth_date', 'profile_picture',
            'phone_number', 'address', 'emergency_contact', 'join_date',
            'nationality', 'blood_group', 'facebook_url', 'linkedin_url',
            'is_active_profile', 'created_at', 'updated_at', 'created_by', 'updated_by'
        ]
...
class StudentProfileSerializer(DynamicFieldsModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'user', 'user_id', 'grade_level', 
            'roll_number', 'admission_date', 'father_name', 'mother_name',
            'guardian_name', 'guardian_phone', 'guardian_email', 'current_gpa',
            'attendance_percentage', 'previous_school', 'medical_conditions',
            'extracurricular_activities', 'created_at', 'updated_at', 
...
class TeacherProfileSerializer(DynamicFieldsModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'user', 'user_id', 'employee_code', 'department',
            'subject_specialization', 'qualification', 'experience_years',
            'hire_date', 'salary', 'employment_type',
            'classes_assigned', 'subjects_teaching',
            'certifications', 'training_completed', 'created_at', 'updated_at',
            'created_by', 'updated_by'
        ]
        read_only_fields = ['created_at', 'updated_at', 'created_by', 'updated_by']
