...
class UserFilterSet(filters.FilterSet):
    ...
    employee_id = filters.CharFilter(
        lookup_expr="icontains", help_text="Filter by employee ID (partial match)"
    )
    student_id = filters.CharFilter(
        lookup_expr="icontains", help_text="Filter by student ID (partial match)"
    )
    ...
    first_name = filters.CharFilter(
        lookup_expr="icontains", help_text="Filter by first name (partial match)"
    )
    last_name = filters.CharFilter(
        lookup_expr="icontains", help_text="Filter by last name (partial match)"
    )
    username = filters.CharFilter(
        lookup_expr="icontains", help_text="Filter by username (partial match)"
    )
    email = filters.CharFilter(
        lookup_expr="icontains", help_text="Filter by email (partial match)"
    )
...
class StudentProfileFilterSet(filters.FilterSet):
    ...
    grade_level = filters.CharFilter(
        lookup_expr="icontains", help_text="Filter by grade level"
    )
    roll_number = filters.CharFilter(
        lookup_expr="icontains", help_text="Filter by roll number"
    )
...
class TeacherProfileFilterSet(filters.FilterSet):
    ...
    department = filters.CharFilter(
        lookup_expr="icontains", help_text="Filter by department"
    )
    subject_specialization = filters.CharFilter(
        lookup_expr="icontains", help_text="Filter by subject specialization"
    )
    employee_code = filters.CharFilter(
        lookup_expr="icontains", help_text="Filter by employee code"
    )
