...
router.register(r"manual-evaluations", ManualEvaluationViewSet, basename="manual-evaluation")
router.register(r"band-score-mappings", BandScoreMappingViewSet, basename="band-score-mapping")
