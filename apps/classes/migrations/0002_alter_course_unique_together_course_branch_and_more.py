...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='course',
            name='branch',
            field=models.ForeignKey(blank=True, help_text='Branch assignment for course', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='courses', to='acounts.branch'),
        ),
        migrations.AddField(
            model_name='lesson',
            name='pdf_url',
            field=models.URLField(blank=True, help_text='PDF document URL', max_length=500, null=True),
        ),
        migrations.AlterUniqueTogether(
            name='course',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lesson', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='progress', to='classes.lesson')),
